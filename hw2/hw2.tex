...
Let $\beta_{0}^{*}$ and $\beta_{1}^{*}$ denote the coefficients for the ordinary least squares (O.L.S) solution,
...
\begin{center}
    \[
        \beta_0^* = \bar{Y} - \beta_1^* * \bar{X} \rightarrow \frac{1}{n}\sum_{i = 1}^{n}(Y(i) - \beta_1^* * X)
    \]
    \[
        \beta_1^* =
        \beta_{1}^{*} = \frac{\sum_{i = 1}^{n}(X(i) - \bar{X})(Y(i)-\bar{Y})}{\sum_{i = 1}^{n}(X(i)-\bar{X})^2}
    \]\[
        \rightarrow \beta_{1}^{*} = \frac{\sum_{i = 1}^{n}(X(i) - X)(Y(i)-\frac{1}{n}\sum_{i = 1}^{n}Y(i))}{\sum_{i = 1}^{n}(X(i)-X)^2}
    \]\[
        \rightarrow \beta_{1}^{*} = \frac{\sum_{i = 1}^{n}(X(i))(\frac{1}{n}Y(i)}{\sum_{i = 1}^{n}(X(i))^2}
    \]
\end{center}
